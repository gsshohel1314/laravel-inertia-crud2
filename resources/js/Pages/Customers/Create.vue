...
<template>
    <Head>
        <title>Create</title>
        <meta head-key="description" name="description" content="This is customer create page">
    </Head>
    ...
    <section class="mx-auto max-w-screen-xl px-4 py-16">
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg bg-white p-8">
            ...
            <Form :action="route('customers.store')" method="post" #default="{errors, processing}" class="space-y-6">
